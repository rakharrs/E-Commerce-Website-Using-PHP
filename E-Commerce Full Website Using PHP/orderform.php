...
if (isset($_REQUEST['poid'])) {
	...
	$poid = mysqli_real_escape_string($success,$_REQUEST['poid']);
}else {
...
$getposts = mysqli_query($success, "SELECT * FROM products WHERE id ='$poid'") or die(mysqli_error());
...
//triming name
	try {
		...
		// Check if email already exists
						...
						if(mysqli_query($success, "INSERT INTO orders (uid,pid,quantity,oplace,mobile,odate,ddate) VALUES ('$user','$poid',$quan,'$_POST[address]','$_POST[mobile]','$d','$date')")){
